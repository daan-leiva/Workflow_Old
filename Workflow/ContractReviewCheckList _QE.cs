...
namespace Workflow
{
    public partial class ContractReviewCheckList_QE : Form
    {
        ...
        public ContractReviewCheckList_QE(string jobNo, int workflow_ID)
        {
            InitializeComponent();
        ...
        private void ContractReviewCheckList_QE_Load(object sender, EventArgs e)
        {
            ...
            qeApprovalTextBox.Text = Globals.userName;
            qeApprovalTextBox.Enabled = false;
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                if (exists)
                {
                    string query =
                        ...
                        ",[Approval] = '" + qeApprovalTextBox.Text + "'\n" +
